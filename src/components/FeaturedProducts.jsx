...
export default function FeaturedProducts() {
  const TARGET_CATEGORY_ID = "7Eq1jVF9pOVQxvigO47B";
  ...
  return (
    <SectionContainer>
      <SectionHeader>
        <SectionTitle>Featured <span>Products</span></SectionTitle>
        {/* <ResultsCount>
          Showing <span>{products.length}</span> items
        </ResultsCount> */}
            <ResultsCount style={{color:"#00aeef", cursor:"pointer"}} onClick={()=>router.push('/store')}>
